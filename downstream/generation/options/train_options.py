...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--perceptual_channel', type=int, default=3)
        parser.add_argument('--pretrained_weight_path', type=str, default='models/pretrained_model/SSAP_temp.pth.tar')
        ...
        parser.add_argument('--no_perceptual_loss', action='store_true', help='if specified, do *not* use Perceptual loss')
