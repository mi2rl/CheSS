...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default='NoduleGeneration', help='name of the experiment. It decides where to store samples and models')
        ...
        # for setting inputs
        parser.add_argument('--dataroot', type=str, default='/workspace/changyong/02.MI2RLNet_V2/SPADE_data')
