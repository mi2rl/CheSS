...
def main_worker(gpu, ngpus_per_node, args):
    ...
    criterion_L1 = nn.L1Loss().cuda(args.gpu)
...
def train(train_loader, model, criterion, cos_sim ,criterion_L1, optimizer, epoch, args):
    ...
    for i, (images, _) in enumerate(train_loader):
        ...
        # compute output
        # logits, labels ,layer_query_1 ,layer_query_4, layer_key_1, layer_key_4
        output, target, lq_1 ,lq_4, lk_1, lk_4 = model(im_q=images[0], im_k=images[1])
